...
<div class="ulike-wrapper">
	...
	<div class="container-fluid main-container single-container mobile-container">
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="row single-mobile-title-block">
					<div class="col-md-12 hidden-for-portrait hidden-post-title"  id="hidden-main-title">
						<div class="post-title"><?php the_title(  ); ?>
							...
							<div class="hidden-post-map post-map-btn"><a target="_blank" href="<?php $key="waze"; echo get_post_meta($post->ID, $key, true); ?>"><img src="<?php bloginfo('template_directory'); ?>/img/colors/vegan-mobile-map-icon.png" width="100%"></a></div>
							<div class="hidden-post-call-us"><a href="tel:<?php $key="phone numbers"; echo get_post_meta($post->ID, $key, true); ?>"><img src="<?php bloginfo('template_directory'); ?>/img/colors/vegan-mobile-call-icon.png" width="100%"></a></div>
							<div class="hidden-share-icon share-icon-btn"><img src="<?php bloginfo('template_directory'); ?>/img/colors/vegan-share_icon.png" width="100%"></div>
						</div>
						<div class="post-reg-info-kosher"><img src="<?php bloginfo('template_directory'); ?>/img/colors/vegan-kosher_star_mobile.png" width="30px"><?php the_field('kosher'); ?></div>
					</div>
				</div>
				<!--END OF MOBILE TITLE -->
...
<!-- MOBILE COLOUR COLUMN WITH INFO-->
						<div class="hidden-info-col-wrapper">
							...
							<div class="col-md-12 col-sm-12 col-xs-12 hidden-for-portrait hidden-post-address">
								...
								<div class="hidden-post-adress-phone"><img src="<?php bloginfo('template_directory'); ?>/img/colors/vegan-loc-icon.png"><?php $key="address"; echo get_post_meta($post->ID, $key, true); ?>
												<br><img src="<?php bloginfo('template_directory'); ?>/img/colors/vegan-phone-icon.png"><?php $key="phone numbers"; echo get_post_meta($post->ID, $key, true); ?>
								</div>
...
<!--HERE BEGINS NEW REGULAR MONITOR PART-->
			<div class="container-fluid main-container single-container regular-container">
				<div class="row">
					<div class="col-lg-12">
<!------------------------------------------------------------------------- -->
						<div class="page-header-single">
									...
									<div class="post-reg-info-text-col">
										...
										<div class="post-reg-info-text-wrapper">
											...
											<div class="post-reg-info-address">
												...
												<img src="<?php bloginfo('template_directory'); ?>/img/colors/vegan-loc-icon.png"><?php $key="address"; echo get_post_meta($post->ID, $key, true); ?>
												<br><img src="<?php bloginfo('template_directory'); ?>/img/colors/vegan-phone-icon.png"><?php $key="phone numbers"; echo get_post_meta($post->ID, $key, true); ?>
												<div class="post-reg-info-kosher"><img src="<?php bloginfo('template_directory'); ?>/img/colors/vegan-kosher_star.png" alt=""><?php the_field('kosher'); ?></div>
											</div>
						...
						<div class="post-reg-description-block">
								<div class="post-reg-description-wrapper">
									<div class="post-reg-description-quote-right"><img src="<?php bloginfo('template_directory'); ?>/img/colors/vegan-quotes-image.png" width="100%"></div>
									<?php $key="description"; echo get_post_meta($post->ID, $key, true); ?>
									<div class="post-reg-description-quote-left"><img src="<?php bloginfo('template_directory'); ?>/img/colors/vegan-quotes-image.png" width="100%"></div>
								</div>
							</div>
